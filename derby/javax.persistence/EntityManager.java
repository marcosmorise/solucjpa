...
public class EntityManager {
     ...
     */
    private static String getTableDefinition(Class entityType) {
     ...
     */
    private static Boolean isEntitiesEquals(Object entity1, Object entity2) throws SQLException {
        Boolean equals = true;
     ...
     * @return id field
     */
    private static Field getClassId(Class entityType) {
        Field fieldId = null;
     ...
     * @return id field
     */
    private static Field getEntityId(Object entity) {
        Field fieldId = null;
     ...
     */
    private static Method getFieldGetter(Object entity, Field field) {
        Method getter;
     ...
     */
    private static Method getFieldSetter(Object entity, Field field) {
        Method setter;
        String fieldName = field.getName().substring(0, 1).toUpperCase() + (field.getName().length() > 1 ? field.getName().substring(1) : "");
        try {
     ...
     * @throws SQLException
     */
    private static int entityToStatement(Object entity, PreparedStatement statement) throws SQLException {
        //Setting values for statement
        int i = 0;
        for (Field field : entity.getClass().getDeclaredFields()) {
            try {
                //if (!field.isAnnotationPresent(GeneratedValue.class) && (field.isAnnotationPresent(Column.class) || field.isAnnotationPresent(Temporal.class) || field.isAnnotationPresent(Lob.class) || field.isAnnotationPresent(ManyToOne.class))) {
    ...
    /**
     * Private createTable used to create Tables child from entity OneToMany
     *
     * @param connection
     * @param owner
     * @param ownerField
     ...
     * @throws SQLException
     */
    private static void createTable(Connection connection, Class owner, Field ownerField, Class child) throws SQLException {
     ...
     * @throws SQLException
     */
    private static void insert(Connection connection, Object owner, Field ownerField, Object entity) throws SQLException {
    ...
    //* Queries Commands
    //*********************************************
    private static void resultSetToEntity(Connection connection, ResultSet resultSet, Object entity) throws SQLException {
        try {
